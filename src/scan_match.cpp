...
public:
    ...
    void publishPos() {
        ...
        vector<Point> global_transformed_points;
        Transform t(global_tf(0, 2), global_tf(1, 2), q.getAngle());
        transformPoints(points, t, global_transformed_points);
        points_viz->addPoints(global_transformed_points, col);
